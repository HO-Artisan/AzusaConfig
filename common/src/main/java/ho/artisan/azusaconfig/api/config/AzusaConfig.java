...
package ho.artisan.azusaconfig.api.config;
...
public final class AzusaConfig {
    ...
    public static Config create(String family, String id, Path path, Config.Creator... creators) {
        return ConfigImpl.create(AzusaConfigImpl.getConfigEnvironment(), family, id, path, creators);
    }
    ...
    public static <C extends WrappedConfig> C create(String family, String id, Path path, Config.Creator before, Class<C> configCreatorClass, Config.Creator after) {
        return Config.create(AzusaConfigImpl.getConfigEnvironment(), family, id, path, before, configCreatorClass, after);
    }
